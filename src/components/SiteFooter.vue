...
<template>
  <footer class="site-footer">
    <p class="titulo">Otras líneas de emergencia</p>
    <ul class="lineas-numeros">
      <li>Bomberos: 119</li>
      <li>Cruz Roja: 132</li>
      <li>Defensa Civil: 144</li>
      <li>Movilidad: 127</li>
    </ul>
    <p class="rfl">
    ...
    <p class="independencia">
      Proyecto independiente y voluntario, creado por un ciudadano. Sin relación con ninguna
      entidad gubernamental, ONG, fundación u organización sin ánimo de lucro.
    </p>
  </footer>
</template>
